    ...
    <div class="container mt-3">
        ...
        <form action="" method="post" class="mt-3">
            <div class="mb-3">
                ...
                <input value="<?php echo !$_POST ? $product['productId']  : $_POST['productId'] ?>" type="text" class="form-control" id="name" name="productId" required>
            </div>
            <div class="mb-3">
                <label for="productName" class="form-label">Product Name :</label>
                <input value="<?php echo !$_POST ? $product['productName']  : $_POST['productName'] ?>" type="text" class="form-control" id="phoneNumber" name="productName" required>
            </div>
            <div class="mb-3">
                <label for="price" class="form-label">Price :</label>
                <input value="<?php echo !$_POST ? $product['price']  : $_POST['price'] ?>" type="text" class="form-control" id="address" name="price" required>
            </div>
            <button type="submit" class="btn btn-primary" name="editProduct">Edit</button>
            <button type="submit" class="btn btn-danger" name="deleteProduct" onclick="confirm('Are you sure?')">Delete</button>
